...
describe('useMentions', () => {
  ...
  it('should call useInfiniteQuery with mentions query key', () => {
    renderHook(() => useMentions());
  ...
  it('should call getMentions with page param', () => {
    const { getMentions } = require('../../services/notificationService');
    ...
    expect(getMentions).toHaveBeenCalledWith({ page: 2 });
  });
